...
public class ACLDeserializer {
    ...
    private static final String CanonicalGranteeType = "canonical";
    private static final String GroupGranteeType = "group";
    private static final String EmailGranteeType = "email";
